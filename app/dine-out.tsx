          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.offersScroll}>
            <View style={[styles.offerCard, styles.offerCardPrimary]}>
              ...
              <View style={styles.offerContent}>
                <Text style={styles.offerTitle}>20% Off on Dine In</Text>
                <Text style={styles.offerDescription}>Pay your bill and get instant discount</Text>
                <View style={styles.offerFooter}>
                  <Text style={styles.offerCode}>Use: DINE20</Text>
                  <Ionicons name="copy" size={14} color="#7c3aed" />
                </View>
              </View>
            </View>
            ...
            <View style={styles.offerCard}>
              <View style={styles.offerCardHeader}>
                <View style={[styles.offerIcon, styles.offerIconSecondary]}>
                  <Ionicons name="restaurant" size={20} color="#10b981" />
                </View>
                <View style={[styles.offerBadge, styles.offerBadgeSecondary]}>
                  <Text style={[styles.offerBadgeText, styles.offerBadgeTextSecondary]}>NEW</Text>
                </View>
              </View>
              <View style={styles.offerContent}>
                <Text style={styles.offerTitle}>Free Dessert</Text>
                <Text style={styles.offerDescription}>Order above ₹500 and get free dessert</Text>
                <View style={styles.offerFooter}>
                  <Text style={styles.offerCode}>Min. ₹500</Text>
            ...
            <View style={styles.offerCard}>
              <View style={styles.offerCardHeader}>
                <View style={[styles.offerIcon, styles.offerIconTertiary]}>
                  <Ionicons name="time" size={20} color="#f59e0b" />
                </View>
                <View style={[styles.offerBadge, styles.offerBadgeTertiary]}>
                  <Text style={[styles.offerBadgeText, styles.offerBadgeTextTertiary]}>LIMITED</Text>
                </View>
              </View>
              <View style={styles.offerContent}>
                <Text style={styles.offerTitle}>Happy Hour</Text>
                <Text style={styles.offerDescription}>2-5 PM: 30% off on beverages</Text>
                <View style={styles.offerFooter}>
                  <Text style={styles.offerCode}>2:00 PM - 5:00 PM</Text>
