import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Image, TextInput, Linking, Modal, ActivityIndicator } from "react-native";
          ...
          <View style={styles.successModalCard}>
            ...
            <View style={styles.successDetailsCard}>
              <View style={styles.bookingCodeContainer}>
                ...
                <Text style={styles.bookingCodeNote}>Show this code at the reception</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  dateInput: { height: 44, backgroundColor: "#f9fafb", borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 10, paddingHorizontal: 12, color: "#111827", fontWeight: "600", flex: 1, paddingRight: 40 },
