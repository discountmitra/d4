...
import { View, Text, StyleSheet, Image, TouchableOpacity, ScrollView, TextInput, Alert, Animated } from "react-native";
...
export default function TakeAwayScreen() {
  ...
  const handleOrder = () => {
    ...
    Alert.alert(
      'Order Placed',
      `Order Total: ₹${cartTotal}\n\nYour order has been sent to the restaurant. You will be notified once they accept it.`,
      [{ text: 'OK', onPress: () => {
